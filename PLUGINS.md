...
- **`/openshift:set-operator-override` `[--set-unmanaged <operator> [--scale-down]] [--set-managed <operator>] [--list]`** - Set cluster operators as managed or unmanaged for troubleshooting
